<?php
/**
 * Argeau functions and definitions
 *
...
if (!function_exists('argeau_setup')) :
    /**
     ...
     */
    function argeau_setup()
    {
        /*
         * Make theme available for translation.
         * Translations can be filed in the /languages/ directory.
         * If you're building a theme based on Argeau, use a find and replace
         * to change 'argeau' to the name of your theme in all the template files.
         */
        load_theme_textdomain('argeau', get_template_directory() . '/languages');
        ...
        register_nav_menus(
            array(
                'menu-1' => esc_html__('Primary', 'argeau'),
            )
        );
...
add_action('after_setup_theme', 'argeau_setup');
 ...
 */
function argeau_content_width()
{
    $GLOBALS['content_width'] = apply_filters('argeau_content_width', 640);
}

add_action('after_setup_theme', 'argeau_content_width', 0);
 ...
 */
function argeau_widgets_init()
{
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'argeau'),
            'id' => 'sidebar-1',
            'description' => esc_html__('Add widgets here.', 'argeau'),
...
add_action('widgets_init', 'argeau_widgets_init');

/**
 * Enqueue scripts and styles.
 */
function argeau_scripts()
{
    ...
    wp_style_add_data('argeau-style', 'rtl', 'replace');

    wp_enqueue_script('argeau-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
...
add_action('wp_enqueue_scripts', 'argeau_scripts');
...
/**
 * Disable standard post text editor
 */
